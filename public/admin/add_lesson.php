...
if (isset($_POST['s']) and $_POST['s'] == 1) {
    ...
    $editor = trim($editor);
    if (!empty($editor) and !empty($topic_id) and !empty($lesson_title)) {
        $sql = "INSERT INTO lessons (topic_id, lesson_title, content)VALUES('$topic_id', '$lesson_title', '$editor')";
        if ($result = $conn->query($sql)) {
            header('location:lessons.php?add_lesson=success');
        }
    } else {
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
        <div class="container-fluid col-md-10">
            <div class="form-row mt-5">
                ...
                <input type="text" class="form-control mb-4" name="lesson_title">
            </div>
            ...
            <textarea name="editor" id="editor" cols="50" rows="50"></textarea>
